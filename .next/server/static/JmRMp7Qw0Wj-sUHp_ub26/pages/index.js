...
var MenuBookRounded_default = /*#__PURE__*/__webpack_require__.n(MenuBookRounded_);

// EXTERNAL MODULE: external "@material-ui/core"
var core_ = __webpack_require__("KKbo");

// CONCATENATED MODULE: ./components/singlePost/SinglePost.tsx
...
function SinglePost({
  ...
  }, __jsx(Delete_default.a, null)), __jsx(Typography_default.a, null, __jsx(core_["Link"], {
    href: `posts/${id}`
  }, __jsx(IconButton_default.a, {
    "aria-label": "read more"
  }, __jsx(MenuBookRounded_default.a, null))))));
}
// CONCATENATED MODULE: ./components/postListItem/PostListItem.js

var PostListItem_jsx = external_react_default.a.createElement;


const Li = external_styled_components_default.a.li`
  min-width: 30%;
`;
...
const PostListItem = ({
  ...
  return PostListItem_jsx(Li, null, PostListItem_jsx(SinglePost, {
    post: post
  }));
};

/* harmony default export */ var postListItem_PostListItem = (PostListItem);
...
const PostList = () => {
  ...
  const hasElement = (post, idx) => {
    return PostList_jsx(postListItem_PostListItem, {
      key: idx,
      post: post
    });
  };

  return PostList_jsx(List, null, posts.length ? posts.map((post, idx) => hasElement(post, idx)) : PostList_jsx(Loader["a" /* default */], null));
};
...
const IndexPage = () => {
  ...
  const getInitialProps = async () => {
    await dispatch(Object(postsOperation["d" /* getPosts */])());
  };

  getInitialProps();
  return pages_jsx(Layout["a" /* default */], null, pages_jsx(postList_PostList, null));
};
